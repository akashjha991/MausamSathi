...
export default function Home() {
  ...
  // Load AdSense script with verification
  useEffect(() => {
    // AdSense verification and main script
    const script = document.createElement('script');
    script.src = 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2351040456899601';
    script.async = true;
    ...
    script.onload = () => {
      try {
        (window.adsbygoogle = window.adsbygoogle || []).push({
          google_ad_client: "ca-pub-2351040456899601",
